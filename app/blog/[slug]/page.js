                ...
                <div className="article-slider">
                  {otherPosts.map((other, idx) => (
                    <div key={other.slug} className="article-slide">
                      <div
                        className={`article-slide-content ${idx === 0 ? "active" : ""}`}
                      >
                        <div className="article-slide-description">
                          ...
                          {other.excerpt && (
                            <p>
                              {other.excerpt
                                .replace(/<[^>]+>/g, "")
                                .slice(0, 280) || ""}
                              {other.excerpt.replace(/<[^>]+>/g, "").length >
                              280
                                ? "…"
                                : ""}
                            </p>
                          ...
                          <Link
                            href={`/blog/${encodeURIComponent(other.slug)}`}
                          >
                            Читать далее
                          </Link>
                        </div>
                        {other.featured_image ? (
                          ...
                          <img
                            src="/uploads/2023/05/Rectangle-225.png"
                            alt=""
                          />
                        )}
                      </div>
                      <div
                        className={`article-slide-btn ${idx === 0 ? "active" : ""}`}
                      >
                        {idx + 1}
                      </div>
                    </div>
