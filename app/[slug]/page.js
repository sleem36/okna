...
export async function generateMetadata({ params }) {
  if (params.slug === EDGING_SLUG) {
    return {
      title:
        "Окантовка для мягких окон купить в Москве | Стоимость оконтовки | Мягкие окна Стиль",
      description:
        "Окантовка для мягких окон. Прочные, гибкие материалы, быстрая установка и долговечность. Быстрая доставка до двери. Мягкие окна «Стиль» уже более 7 лет занимаются производством",
    };
  }
  if (params.slug === FURNITURA_SLUG) {
    return {
      title:
        "Фурнитура для мягких окон купить в Москве | Цена на фурнитуру | Мягкие окна Стиль",
      description:
        "Фурнитура для мягких окон. Прочные, гибкие материалы, быстрая установка и долговечность. Как правильно выбрать и установить фурнитуру, чтобы обеспечить надежность мягких окон. Мягкие окна «Стиль»",
    };
  }
  if (params.slug === DOORS_SLUG) {
    return {
      title:
        "Мягкие двери купить в Москве | Цены на двери для мягких окон | Мягкие окна Стиль",
      description:
        "Мягкие двери. Прочные, гибкие материалы, быстрая установка и долговечность. Быстрая доставка до двери. Мягкие окна «Стиль» уже более 7 лет занимаются производством",
    };
  }
  if (params.slug === DELIVERY_SLUG) {
    return {
      ...
      description:
        "Доставка мягких окон. Прочные, гибкие материалы, быстрая установка и долговечность. Быстрая доставка до двери. Мягкие окна «Стиль» уже более 7 лет занимаются производством",
    };
  }
  if (params.slug === ZAMER_SLUG) {
    return {
      ...
      description:
        "Замер мягких окон . Прочные, гибкие материалы, быстрая установка и долговечность. Как правильно выбрать и установить фурнитуру, чтобы обеспечить надежность мягких окон. Мягкие окна «Стиль»",
    };
  }
  if (params.slug === MONTAZH_SLUG) {
    return {
      ...
      description:
        "Монтаж мягких окон. Прочные, гибкие материалы, быстрая установка и долговечность. Как правильно выбрать и установить фурнитуру, чтобы обеспечить надежность мягких окон. Мягкие окна «Стиль»",
    };
  }
  ...
  if (params.slug === CENA_SLUG) {
    return {
      title:
        "Цены на мягкие окна от 1200 рублей м² без монтажа | Мягкие окна Стиль",
      description:
        "Цены. Прочные, гибкие материалы, быстрая установка и долговечность. Быстрая доставка до двери. Мягкие окна «Стиль» уже более 7 лет занимаются производством",
    };
  }
  ...
  if (params.slug === CONTACTS_SLUG) {
    return {
      title: "Контакты — Мягкие окна Стиль",
      description: "",
    };
  }
  ...
  return {
    title: `${page.title} — Мягкие окна Стиль`,
