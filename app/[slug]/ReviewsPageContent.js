...
const REVIEWS_SLIDES = Array.from({ length: 29 }, (_, i) => `/uploads/2023/11/${i + 1}.jpg`);
            ...
            <div className="main__block">
              <div className="main__text">
                <div className="main__text-title">
                  <div className="panel__text mobile_title">{REVIEWS_HERO.panelText}</div>
                  <h1>{REVIEWS_HERO.title}</h1>
                </div>
              </div>
              <div className="main__img">
                <img src={REVIEWS_HERO.img} alt="" style={{ width: '89%', height: '104%', objectFit: 'cover' }} />
              </div>
            </div>
            <div className="main__panel">
              <div className="panel__wrapper">
                <Link href={REVIEWS_HERO.buttonHref} className="panel__btn">
                  <div>{REVIEWS_HERO.buttonText}</div>
                </Link>
                <div className="panel__arrow">
                  <img src="/theme/img/mainArrow.svg" alt="" />
                </div>
                <div className="panel__text">{REVIEWS_HERO.panelText}</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="reviews__wrapper">
            <div className="reviews__content">
              <div className="reviews__content-slider">
                ...
                <div className="reviews-prev" tabIndex={0} role="button" aria-label="Предыдущий слайд">
                ...
                <div className="reviews-next" tabIndex={0} role="button" aria-label="Следующий слайд">
                  <svg width="11" height="18" viewBox="0 0 11 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
