            ...
            <div className="main__block">
              <div className="main__text">
                <div className="main__text-title">
                  <div className="panel__text mobile_title">{FURNITURA_HERO.panelText}</div>
                  <h1 style={{ whiteSpace: 'pre-line' }}>{FURNITURA_HERO.title}</h1>
                </div>
              </div>
              <div className="main__img">
                <img src={FURNITURA_HERO.img} alt="" style={{ width: '89%', height: '104%', objectFit: 'cover' }} />
              </div>
            </div>
            <div className="main__panel">
              <div className="panel__wrapper">
                <Link href={FURNITURA_HERO.buttonHref} className="panel__btn">
                  <div>{FURNITURA_HERO.buttonText}</div>
                </Link>
                <div className="panel__arrow">
                  <img src="/theme/img/mainArrow.svg" alt="" />
                </div>
                <div className="panel__text">{FURNITURA_HERO.panelText}</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="seo_block__wrapper">
            <div className="seo_block-title">
              <h2>{FURNITURA_SEO_TITLE}</h2>
            </div>
            <div className="seo_block-subtitle" dangerouslySetInnerHTML={{ __html: FURNITURA_SEO_HTML }} />
