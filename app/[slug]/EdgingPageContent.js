...
// Данные секций как на главной (дублируем для независимости страницы)
const WORKS_TABS = [
  { index: 0, label: 'Все' },
...
export default function EdgingPageContent() {
  return (
    <>
            ...
            <div className="main__block">
              <div className="main__text">
                <div className="main__text-title">
                  <div className="panel__text mobile_title">{EDGING_HERO.panelText}</div>
                  <h1>{EDGING_HERO.title}</h1>
                </div>
              </div>
              <div className="main__img">
                <img src={EDGING_HERO.img} alt="" style={{ width: '89%', height: '104%', objectFit: 'cover' }} />
              </div>
            </div>
            <div className="main__panel">
              <div className="panel__wrapper">
                <Link href={EDGING_HERO.buttonHref} className="panel__btn">
                  <div>{EDGING_HERO.buttonText}</div>
                </Link>
                <div className="panel__arrow">
                  <img src="/theme/img/mainArrow.svg" alt="" />
                </div>
                <div className="panel__text">{EDGING_HERO.panelText}</div>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Калькулятор — как на главной, id="calc1" для якоря с hero */}
        ...
        <div className="container">
          <div className="seo_block__wrapper">
            <div className="seo_block-title">
              <h2>{EDGING_SEO_TITLE}</h2>
            </div>
            <div className="seo_block-subtitle" dangerouslySetInnerHTML={{ __html: EDGING_SEO_HTML }} />
