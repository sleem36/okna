...
import { getWorkBySlug, getAllWorkSlugs, TYPE_LABELS } from '../../../lib/our-works-page-data';
...
export default async function OurWorkDetailPage({ params }) {
  ...
  const images = [work.imagePath, work.imagePath2, work.imagePath3].filter(Boolean);
                    ...
                    return (
                      <div key={block.key} className="info-content-block">
                        ...
                        <div className="content-block-text">
                          <div className="content-block-text-title">{block.title}</div>
                          <div className="content-block-text-subtitle">{value}</div>
                        </div>
                      </div>
                    );
                  })}
