...
export const metadata = {
  title:
    "Мягкие окна в Москве | Цены на мягкие окна для террасы и веранды | Стиль",
  description:
    "Изготовление и установка мягких окон в Москве. Цены от 1100 руб/м². Мягкие окна для террасы, веранды, беседки. Собственное производство, 8 лет на рынке.",
  openGraph: {
    title:
      "Мягкие окна в Москве | Цены на мягкие окна для террасы и веранды | Стиль",
    description:
      "Изготовление и установка мягких окон в Москве. Цены от 1100 руб/м². Мягкие окна для террасы, веранды, беседки.",
    type: "website",
    locale: "ru_RU",
  ...
  info: [
    {
      ...
      subtitle:
        "Наша компания существует на рынке мягких окон уже более 8 лет и за свою историю произвели более 10 тысяч заказов разной сложности. Весь персонал квалифицированный c большим опытом работы.",
    },
    {
      title: "Надежность",
      subtitle:
        "Выбирая нас в качестве исполнителей вы попадаете в профессиональные руки. У нас собственное производство с русскоязычным персоналом. Наработанный годами опыт позволяет предлагать нашим клиентам только избранные и лучшие материалы",
    },
  ],
  blocks: [
    ...
    {
      title: "1000 м²",
      text: "готовых изделий в месяц создается на нашем производстве",
      yellow: false,
    },
    {
      title: "5 дней",
      text: "от момента заказа до установки готовых конструкций",
      yellow: false,
    },
...
const REASON_ITEMS = [
  {
    img: "/uploads/2024/08/free-icon-thumbs-up-4425133.png",
    text: "Удобство использования",
  },
  {
    img: "/uploads/2024/08/free-icon-full-size-93640.png",
    text: "Индивидуальные размеры",
  },
  {
    img: "/uploads/2024/08/free-icon-antivirus-2603214.png",
    text: "Безопасно для детей и животных",
  },
  {
    img: "/uploads/2024/08/free-icon-discount-6516777.png",
    text: "Дешевле пластиковых окон",
  },
  {
    img: "/uploads/2024/08/free-icon-weather-protection-17111162.png",
    text: "Защита от непогоды",
  },
  {
    img: "/uploads/2024/08/free-icon-transparent-5241776.png",
    text: "Прозрачность окон 98%",
  },
  {
    img: "/uploads/2024/08/free-icon-light-bulb-16504777.png",
    text: "Большой спектр применений",
  },
  {
    img: "/uploads/2024/08/free-icon-temperature-1582842.png",
    text: "Устойчивые к разным (C°)",
  },
  {
    img: "/uploads/2024/08/free-icon-water-resistant-9393537.png",
    text: "Защита от ветра и воды",
  },
];
...
const WORKS_SLIDES = [
  [
    { img: "/uploads/2023/05/per.jpg", title: "", link: "#" },
    { img: "/uploads/2024/08/1-1.jpg", title: "", link: "#" },
    { img: "/uploads/2024/08/1-2.jpg", title: "", link: "#" },
  ],
  [
    {
      img: "/uploads/2024/09/1-5.jpg",
      title: "Терраса с Раменского",
      link: "#",
    },
    {
      img: "/uploads/2024/09/1-6.jpg",
      title: "Терраса из Щелковского",
      link: "#",
    },
    {
      img: "/uploads/2024/09/1-7.jpg",
      title: "Терраса в Ногинском",
      link: "#",
    },
  ],
  [
    {
      img: "/uploads/2023/05/per.jpg",
      title: "Беседка в Ногинском районе",
      link: "#",
    },
    {
      img: "/uploads/2024/08/1-1.jpg",
      title: "Беседка в Сергиево-посадском районе",
      link: "#",
    },
    {
      img: "/uploads/2024/08/1-2.jpg",
      title: "Беседка из СНТ Галактика",
      link: "#",
    },
  ],
  [
    {
      img: "/uploads/2024/09/1-18.jpg",
      title: "Дача в Дмитровском",
      link: "#",
    },
    { img: "/uploads/2024/09/1-19.jpg", title: "Дача в Хотьково", link: "#" },
    {
      img: "/uploads/2024/09/1-20.jpg",
      title: "Дача в Одинцовском",
      link: "#",
    },
  ],
  [
    {
      img: "/uploads/2024/08/1-21.jpg",
      title: "Веранда Солнечногорск",
      link: "#",
    },
    { img: "/uploads/2024/08/1-24.jpg", title: "Веранда Бронницы", link: "#" },
    {
      img: "/uploads/2024/08/1-23.jpg",
      title: "Веранда СНТ Здоровье",
      link: "#",
    },
  ],
  [
    {
      img: "/uploads/2024/09/1-11.jpg",
      title: "Промышленное помещение из Ногинского",
      link: "#",
    },
    {
      img: "/uploads/2024/09/1-12.jpg",
      title: "Промышленное помещение из Ногинска",
      link: "#",
    },
    {
      img: "/uploads/2024/09/1-13.jpg",
      title: "Уличный шатер Сергиево-посадский",
      link: "#",
    },
  ],
];
...
const REVIEWS_IMAGES = Array.from(
  { length: 29 },
  (_, i) => `/uploads/2023/11/${i + 1}.jpg`,
);
...
const EDGING_CARDS = [
  {
    ...
    items: [
      "морозостойкая пленка 700 мкм до -39",
      "окантовка стандарт Оксфорд",
      "крепление скоба с силиконовым белым ремнем",
    ],
  ...
  },
  {
    ...
    items: [
      "морозостойкая пленка 700 мкм до -39",
      "окантовка люкс Оксфород 1680",
      "крепление полимерная поворотная скоба",
    ],
  ...
  },
  {
    ...
    items: [
      "морозостойкая пленка 700 мкм до -39",
      "окантовка премиум ПВХ",
      "крепление большая поворотная металлическая скоба",
    ],
...
const PRICE_CARDS = [
  {
    img: "/uploads/2024/09/krepleniya-1611.jpg",
    title: "Стандарт",
    ...
    colorsInStock: [
      "/uploads/2023/05/Rectangle-208.png",
      "/uploads/2023/05/Rectangle-91.png",
      "/uploads/2023/05/Rectangle-90.png",
    ],
    colorsOnOrder: [],
  },
  {
    img: "/uploads/2024/09/krepleniya-1614.jpg",
    title: "Люкс",
    ...
    colorsInStock: [
      "/uploads/2023/05/Rectangle-91.png",
      "/uploads/2023/05/Rectangle-207.png",
      "/uploads/2023/05/Rectangle-90.png",
      "/uploads/2023/05/Rectangle-89.png",
      "/uploads/2023/05/Rectangle-208.png",
    ],
    colorsOnOrder: [],
  },
  {
    img: "/uploads/2024/09/krepleniya-1632.jpg",
    title: "Премиум",
    ...
    colorsInStock: [
      ...
      "/uploads/2023/05/Rectangle-207.png",
      "/uploads/2023/05/Rectangle-208.png",
      "/uploads/2023/05/Rectangle-214.png",
    ],
    colorsOnOrder: [
      "/uploads/2023/05/Rectangle-216.png",
      "/uploads/2023/05/Rectangle-217.png",
      "/uploads/2023/05/Rectangle-218.png",
      "/uploads/2023/05/Rectangle-219.png",
    ],
  },
];
...
const FURNITURE_ITEMS = [
  {
    img: "/uploads/2024/08/krepleniya-1485-1.jpg",
  ...
  {
    img: "/uploads/2024/08/krepleniya-1439.jpg",
  ...
  {
    img: "/uploads/2024/08/krepleniya-1401.jpg",
  ...
  {
    img: "/uploads/2024/08/krepleniya-1407-1.jpg",
  ...
  {
    img: "/uploads/2024/08/krepleniya-1479.jpg",
  ...
  {
    img: "/uploads/2024/08/krepleniya-1413-1.jpg",
...
const CALC_FASTENERS = [
  ...
  {
    img: "/uploads/2024/08/krepleniya-1401.jpg",
    label: "Поворотная скоба",
    value: 1400,
    index: 1,
  },
  {
    img: "/uploads/2024/08/krepleniya-1413-1.jpg",
    label: "Французкий замок",
    value: 1900,
    index: 2,
  },
  {
    img: "/uploads/2024/08/krepleniya-1485-1.jpg",
    label: "Люверс для жесткого крепления",
    value: 1200,
    index: 3,
  },
];
            ...
            <div className="advantages__content">
              ...
              <div className="advantages__blocks">
                <div className="advantages__blocks-block">
                  <div
                    className={
                      ADVANTAGES.blocks[0].yellow
                        ? "block-content block-content-yellow"
                        : "block-content"
                    }
                  >
                    ...
                    <div className="block-title-info">
                      {ADVANTAGES.blocks[0].text}
                    </div>
                  </div>
                  <div
                    className={
                      ADVANTAGES.blocks[1].yellow
                        ? "block-content block-content-yellow"
                        : "block-content"
                    }
                  >
                ...
                <div className="advantages__blocks-block">
                  ...
                  >
                    ...
                    <div className="block-title-info">
                      {ADVANTAGES.blocks[2].text}
                    </div>
                  </div>
                  <div
                    className={
                      ADVANTAGES.blocks[3].yellow
                        ? "block-content block-content-yellow"
                        : "block-content"
                    }
                  >
        ...
        <div className="container">
          <div className="reason__wrapper">
            <div className="reason-title">
              <h2>
                <span>Причина выбрать </span>мягкие окна
              </h2>
            </div>
              ...
              >
                ...
                >
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M8.90078 1.03835L9.80078 1.90415L2.60078 8.83048L9.80078 16.0956L8.90078 16.9614L1.70078 9.69628L0.800781 8.83048L8.90078 1.03835Z"
                    fill="#263238"
                    stroke="#263238"
              ...
              >
                ...
                >
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M2.03672 16.9616L1.13672 16.0958L8.33672 9.16952L1.13672 1.90437L2.03672 1.03857L9.23672 8.30372L10.1367 9.16952L2.03672 16.9616Z"
                    fill="#263238"
                    stroke="#263238"
                    strokeWidth="0.692308"
                  />
                        ...
                        {slides.map((slide, slideIdx) => (
                          <div key={slideIdx} className="swiper-slide">
                            ...
                            <div className="swiper-slide-hidden">
                              <Link
                                href={slide.link}
                                className="swiper-slide-hidden-link"
                              >
                                Посмотреть
                              </Link>
                            </div>
              ...
              {EDGING_CARDS.map((card) => (
                <div key={card.price} className="price_window__card">
                  ...
                  <ul className="price__card-menu">
                    {card.items.map((item) => (
                      <li key={item} className="price__card-menu-item">
                        {item}
                      </li>
                    ))}
                  </ul>
                  ...
                  <Link
                    href="#price_window_order"
                    className="price__card-btn btn"
                  >
                    Оставить заявку
                  </Link>
                </div>
        ...
        <div className="container">
          <div className="vslider-wrap">
            ...
            <div className="vslider-counter">
              <span className="vslider-counter__current">1</span> /{" "}
              {VIDEO_SLIDES.length}
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="price_window_order contacts_order">
            <div className="price_window_order-title">
              ...
              <p>
                Оставьте заявку и получите ремешки для мягких окон в подарок
              </p>
            </div>
            <form
        ...
        <div className="container">
          <div className="calculate__wrapper">
            <div className="calculate__title">
              <h2>
                <span>Рассчитайте стоимость</span> ваших мягких окон
              </h2>
              <p>И оставьте заявку</p>
            </div>
            <form className="calculate__form" id="calc1" action="#">
              <div className="calculate__form-calculator">
                <div className="calculate__form-title">
                  Калькулятор стоимости
                </div>
                <div
                  className="calculate__form-block range__slider"
                  data-min="0"
                  data-max="100"
                >
                  <input
                    type="range"
                    className="calculate__form-inp range"
                    defaultValue={1}
                    max={100}
                    min={0}
                  />
                  ...
                  <input
                    type="text"
                    name="meters"
                    className="calculate__form-inp squares"
                    placeholder="1 м²"
                    defaultValue="1"
                  />
                </div>
                ...
                >
                  <input
                    type="range"
                    className="calculate__form-inp range range_delivery"
                    defaultValue={0}
                    max={100}
                    min={0}
                  />
                  <output
                    className="bubble bubble_delivery"
                  ...
                  <input
                    type="text"
                    name="delivery"
                    className="calculate__form-inp delivery"
                    placeholder="0 км"
                    defaultValue="0"
                  />
                </div>
                <div className="calculate__form-block check">
                  <div className="form-block-check">
                    <label className="control control-checkbox">
                      Монтаж с доставкой{" "}
                      <img src="/theme/img/Truck.svg" alt="" />
                      <input type="checkbox" name="montage" defaultChecked />
                      <div className="control_indicator" />
                    </label>
                  </div>
                  <p className="calculate__form-description">
                    * Минимальная стоимость монтажа -7000 руб. Доставка в
                    пределах МКАД+30км - 1000 руб.
                  </p>
                </div>
                <div className="calculate__form-block">
                  ...
                  <div className="form-block-type fasteners">
                    {CALC_FASTENERS.map((f) => (
                      <div
                        ...
                        data-index={f.index}
                        data-label={f.label}
                        className={`block-type${f.index === 0 ? " active" : ""}`}
                      >
                        <img src={f.img} alt="" />
                        {f.label}
                      </div>
                  ...
                  <input
                    type="hidden"
                    name="krepezh_name"
                    defaultValue={CALC_FASTENERS[0].label}
                  />
                  <input
                    type="hidden"
                    name="krepezh_price"
                    defaultValue={String(CALC_FASTENERS[0].value)}
                  />
                </div>
              </div>
              <div className="calculate__form-order">
                <div className="calculate__form-block">
                  ...
                  <input
                    type="number"
                    name="molnia"
                    className="calculate__form-inp lightning"
                    placeholder="0"
                    defaultValue={0}
                  />
                </div>
                <div className="calculate__form-block">
                  ...
                  <input
                    type="number"
                    name="remni"
                    className="calculate__form-inp belt"
                    placeholder="0"
                    defaultValue={0}
                  />
                </div>
                ...
                <div className="calculate__form-title">
                  Оставьте заявку на точный рассчет стоимости мягких окон
                </div>
                <div className="calculate__form-block">
                  ...
                  <input
                    ...
                    name="phone"
                    required
                    className="calculate__form-inp tel"
                    placeholder="+7 (925) 000-99-77"
                  />
                </div>
                ...
                <p className="form-consent">
                  ...
                  <a href="/privacy" >обработкой своих данных</a>
                </p>
              </div>
            </form>
          </div>
      ...
      <section>
        <div className="container">
          <div className="seo_block__wrapper">
            ...
            <div
              className="seo_block-subtitle"
              dangerouslySetInnerHTML={{ __html: SEO_STYLE_HTML_PREVIEW }}
            />
            <div
              className="seo_block-subtitle-expandable"
              dangerouslySetInnerHTML={{ __html: SEO_STYLE_HTML_EXPANDABLE }}
            />
