...
export const WORKS_SLIDES = [
  [{ img: '/uploads/2023/05/per.jpg', title: '', link: '#' }, { img: '/uploads/2024/08/1-1.jpg', title: '', link: '#' }, { img: '/uploads/2024/08/1-2.jpg', title: '', link: '#' }],
  ...
  [{ img: '/uploads/2023/05/per.jpg', title: 'Беседка в Ногинском районе', link: '#' }, { img: '/uploads/2024/08/1-1.jpg', title: 'Беседка в Сергиево-посадском районе', link: '#' }, { img: '/uploads/2024/08/1-2.jpg', title: 'Беседка из СНТ Галактика', link: '#' }],
...
export const REVIEWS_IMAGES = Array.from({ length: 29 }, (_, i) => `/uploads/2023/11/${i + 1}.jpg`);

export const DEFAULT_CALC_FASTENERS = [
  { img: '/uploads/2024/08/krepleniya-1479.jpg', label: 'Скоба -ремень', value: 1300, index: 0 },
  { img: '/uploads/2024/08/krepleniya-1401.jpg', label: 'Поворотная скоба', value: 1400, index: 1 },
  { img: '/uploads/2024/08/krepleniya-1413-1.jpg', label: 'Французкий замок', value: 1900, index: 2 },
  { img: '/uploads/2024/08/krepleniya-1485-1.jpg', label: 'Люверс для жесткого крепления', value: 1200, index: 3 },
];
